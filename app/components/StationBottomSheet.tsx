...
export default function StationBottomSheet({ isOpen, onClose, station, parseSocketInfo }: Props) {
    ...
    return (
        ...
        >
            <div
                className="w-[50%] max-w-md bg-white rounded-[24px] shadow-lg pointer-events-auto"
                style={{
            ...
            >
                <div className="p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-[22px] text-black font-semibold mb-1">{station.name}</h2>
                            <p className="text-[15px] text-gray-500">{station.address}</p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex-1 bg-[#F2F2F7] rounded-2xl p-4">
                                ...
                                return (
                                    <div key={index} className="flex items-center justify-between mb-3 last:mb-0">
                                        <div className="flex items-center gap-3">
                                            <div className="w-[50px] h-[50px] bg-[#34C759]/10 rounded-full flex items-center justify-center">
                                                <Image
                                        ...
                                        <div className="text-[15px] text-[#3C3C43]">
                    ...
                    >
                        <button className="w-full mt-4 py-2 bg-blue-500 text-white rounded-[24px] hover:bg-blue-600 transition-colors">
                            İstasyon Detayları
                        </button>
                    </Link>
                </div>
